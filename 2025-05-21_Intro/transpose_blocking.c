...
/*Explorar como dependen los tiempos respecto al tamaño de la matriz, block size y optimización.
fijo: O0 MSIZE = 512, varias csize-> 1,...,MSIZE, multiplicando de a 2
gcc -O0 ... .c
./a.out 512 1
" 512 2
" 512 4
